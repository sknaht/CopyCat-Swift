...
static NSUInteger const kDNImageFlowMaxSeletedNumber = 99;
...
{
//    DNAssetsViewCell *assetsCell=[self collec]//(DNAssetsViewCell *)[self collectionView:collectionView cellForItemAtIndexPath:indexPath];
//    [assetsCell checkButtonAction:nil];
//    if (assetsCell.isSelected){
//        [assetsCell setIsSelected:NO];
//        [self deseletedAssets:assetsCell.asset];
//    } else
//        [assetsCell setIsSelected:[self seletedAssets:assetsCell.asset]];
